      ...
      <div className="mx-auto max-w-7xl px-5 py-10">
        ...
        {isDemo && (
          <div className="mb-6 flex items-start gap-2 rounded-xl border border-amber-900 bg-amber-950/30 p-4 text-sm text-amber-200">
            ...
            (scripts/run_analysis.py --demo), not real HST observations. Real-data results appear here
            automatically once scripts/fetch_data.py and scripts/run_analysis.py have been run against
            downloaded ACS/WFC products.
          </div>
        )}
