...
- Observational/statistical uncertainty: bootstrap resampling over pixels or
  sources (`bootstrap_statistic`).
- Numerical/convergence uncertainty: fit covariance conditioning and
  reduced chi-square from the nonlinear least-squares solver
